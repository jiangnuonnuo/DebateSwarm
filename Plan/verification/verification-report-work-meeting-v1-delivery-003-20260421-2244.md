...
- Git status snapshot:
  ...
  - ?? backend/ai-agent-api/src/main/java/com/dasi/api/dto/request/MeetingCreateRequest.java
  - ?? backend/ai-agent-api/src/main/java/com/dasi/api/dto/request/MeetingStartRequest.java
  - ?? backend/ai-agent-api/src/main/java/com/dasi/api/dto/response/MeetingActionDTO.java
  - ?? backend/ai-agent-api/src/main/java/com/dasi/api/dto/response/MeetingIssueDTO.java
  - ?? backend/ai-agent-api/src/main/java/com/dasi/api/dto/response/MeetingStatusDTO.java
  - ?? backend/ai-agent-api/src/main/java/com/dasi/api/dto/response/MeetingSummaryDTO.java
  - ?? backend/ai-agent-domain/src/main/java/com/dasi/domain/room/apapter/repository/IMeetingRepository.java
  - ?? backend/ai-agent-domain/src/main/java/com/dasi/domain/room/model/entity/MeetingActionEntity.java
  - ?? backend/ai-agent-domain/src/main/java/com/dasi/domain/room/model/entity/MeetingIssueEntity.java
  - ?? backend/ai-agent-domain/src/main/java/com/dasi/domain/room/model/entity/MeetingSessionEntity.java
  - ?? backend/ai-agent-domain/src/main/java/com/dasi/domain/room/model/valobj/MeetingActionType.java
  - ?? backend/ai-agent-domain/src/main/java/com/dasi/domain/room/model/valobj/MeetingStatus.java
  - ?? backend/ai-agent-domain/src/main/java/com/dasi/domain/room/model/valobj/MeetingStatusVO.java
  - ?? backend/ai-agent-domain/src/main/java/com/dasi/domain/room/model/valobj/MeetingSummaryVO.java
  - ?? backend/ai-agent-domain/src/main/java/com/dasi/domain/room/service/meeting/
  - ?? backend/ai-agent-infrastructure/src/main/java/com/dasi/infrastructure/persistent/dao/IAiMeetingActionDao.java
  - ?? backend/ai-agent-infrastructure/src/main/java/com/dasi/infrastructure/persistent/dao/IAiMeetingIssueDao.java
- Tests/builds checked:
  - Build SUCCESS: mvn -f backend\\pom.xml -pl ai-agent-domain,ai-agent-api,ai-agent-trigger,ai-agent-infrastructure -am -DskipTests compile
  - SQL review: meeting mapper queries select explicit columns only
  - Index review: meeting-table.sql includes uk_meeting_id/idx_room_active/idx_meeting_timeline/idx_meeting_issue
